<?php
    class DaoContientR implements Dao{
        private $connexion;
        ...
        public function findAll(){
            $req = $this->connexion->query('SELECT * FROM Contient_R;');
        ...
        public function findById($id){
            $req = $this->connexion->prepare('SELECT * FROM Contient_R where Id_Ingredient = :Id_Ingredient and Id_Etape = :Id_Etape;');
        ...
        public function insert($donnee){
            $req = $this->connexion->prepare('INSERT INTO Contient_R (Id_Ingredient, Id_Etape, quantite, unite) VALUES (Id_Ingredient, Id_Etape, quantite, unite);');
        ...
        public function update($donnee){
            $req = $this->connexion->prepare('UPDATE Contient_R 
        ...
        public function delete($id){
            $req = $this->connexion->prepare('DELETE FROM Contient_R where Id_Ingredient = :Id_Ingredient and Id_Etape = :Id_Etape;');
            $req->bindParam(':Id_Ingredient', $id[0]);
            $req->bindParam(':Id_Etape', $id[1]);
            $req->execute();
        }
